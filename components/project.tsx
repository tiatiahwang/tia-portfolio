...
function Project({
  ...
  return (
    ...
    >
      <section className='relative bg-gray-100 rounded-lg max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 sm:h-[20rem] hover:bg-gray-200 transition group-even:pl-8'>
